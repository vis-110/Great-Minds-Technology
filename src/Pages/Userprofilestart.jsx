      ...
      <div className='profile-header'>
        <div className='profile_subheader'>
          ...
          <div className='profile_right_side'>
            <h2>{student?.username || "Loading..."}</h2>
            <small>Student</small>
            <p>Location</p>
          </div>
        </div>
          ...
          <CardContent>
            ...
            <div className='student_details_list'>
              ...
              <div className='list_right'>
                <p><strong>:</strong> {student?.username}</p>
                <p><strong>:</strong> {student?.email}</p>
                <p><strong>:</strong> {student?.fullNumber}</p>
