...
import "../Trainer/trainerProfile.css"
...
function VendorProfile() {
    ...
    const navigateEditForm = () => {
        navigate("/dashboard/vendoreditprofile");
    };
              ...
              <CardContent>
                ...
                <div className='student_details_list'>
                  ...
                  <div className='list_right'>
                    <p><strong>:</strong> {vendor?.username}</p>
                    <p><strong>:</strong> {vendor?.email}</p>
                    <p><strong>:</strong> {vendor?.fullNumber}</p>
